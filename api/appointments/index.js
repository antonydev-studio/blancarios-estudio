...
export default async function handler(req, res) {
  ...
  // POST /  — public booking (esta es la ruta que Vercel realmente sirve para
  // el path exacto "/api/appointments"; el mismo bloque en [[...path]].js es
  // inalcanzable ahí, así que el rate limit debe vivir aquí también).
